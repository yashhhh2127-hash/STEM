...
// Interactive views that require a free student or faculty account
...
const MainContent: React.FC = () => {
  ...
  const renderCurrentView = () => {
    // If view requires authentication and user is a guest, show the preview gate
    if (!authUser && PROTECTED_VIEWS.includes(currentView)) {
      return (
        <AuthRequiredGate
          view={currentView}
