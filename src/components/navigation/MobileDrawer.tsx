              ...
              <div className="space-y-2 pt-1">
                {isAdminAuthenticated && (
                  <button
                    ...
                    className="w-full py-2.5 px-3 bg-amber-50 border border-amber-200 text-amber-900 font-bold rounded-xl text-xs flex items-center justify-center gap-1.5"
                  >
                ...
                <button
                  ...
                  className="w-full py-2.5 px-3 bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 transition cursor-pointer"
                >
                  <LogOut className="w-3.5 h-3.5" /> Sign Out ({authUser.role})
                </button>
              </div>
            ) : (
              <button
                ...
                className="w-full py-2.5 px-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl text-xs flex items-center justify-center gap-1.5 shadow-sm transition"
              >
